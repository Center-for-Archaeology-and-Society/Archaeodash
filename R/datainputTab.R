...
dataInputServer <- function(input, output, session, rvals, db) {
  ...
  dataLoaderServer(rvals = rvals, input, output, session)
  ...
  observeEvent(input$action, {
    ...
    rvals$xvar <- tryCatch(input$xvar, error = function(e) {
      return(NULL)
    })
    rvals$xvar2 <- tryCatch(input$xvar2, error = function(e) {
      return(NULL)
    })
    rvals$yvar <- tryCatch(input$yvar, error = function(e) {
      return(NULL)
    })
    rvals$yvar2 <- tryCatch(input$yvar2, error = function(e) {
      return(NULL)
    })
    rvals$data.src <- tryCatch(input$data.src, error = function(e) {
      return(NULL)
    })
    rvals$Conf <- tryCatch(input$data.src, error = function(e) {
      return(NULL)
    })
    rvals$int.set <- tryCatch(input$int.set, error = function(e) {
      return(NULL)
    })
